...
export const CHAR_CONFIG: Record<string, any> = {
  ...
  empresario:    { label: 'Bicheiro',  color: '#e65100', icon: '💼', desc: 'Rouba 2 moedas · Jogo do Bicho (aposta bloq)',   img: bicheiroImg  },
  investigador:  { label: 'X9',        color: '#6a1b9a', icon: '🕵️', desc: 'Espia · Disfarça · Força troca', img: x9Img        },
  juiz:          { label: 'Juiz',      color: '#1b5e20', icon: '⚖️', desc: 'Veredito (6 moedas) · Bloqueia X9 e Bicheiro', img: juizImg      },
